#line 1 "/mnt/6E9A84429A8408B3/_VSC/WEB_UPLOAD/HELTEC_ESPNOW_TREE_BCAST/DataManager.h"
...
/**
 * @brief Distributed I/O data structure - 32 bits total
 */
typedef struct {
    uint32_t words[SHARED_DATA_WORDS];
...
public:
    ...
    void setDistributedIOBit(int bitIndex, bool value);
    bool getDistributedIOBit(int bitIndex) const;
    bool getMyBitState() const; // Get the state of this device's assigned bit
