#line 1 "/mnt/6E9A84429A8408B3/_VSC/WEB_UPLOAD/HELTEC_ESPNOW_TREE_BCAST/SerialCommandHandler.cpp"
...
void SerialCommandHandler::handleIOStatus() {
    ...
    uint32_t sharedData = DATA_MGR.getSharedData();
    bool myBitState = DATA_MGR.getMyBitState();
    
    doc["input_states"] = inputStates;
    doc["output_states"] = outputStates;
    doc["shared_data"] = sharedData;
    doc["my_bit_state"] = myBitState;
